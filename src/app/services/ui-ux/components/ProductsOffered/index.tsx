    ...
    <Section>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 pb-4">
        {products.map((product, index) => (
          <div key={index} className="flex flex-col space-y-4 justify-center items-center text-center shadow-xs shadow-primary/30 hover:shadow-sm hover:scale-[1.03] hover:shadow-primary/50 transition duration-300 cursor-pointer p-6 rounded-lg">
