...
const Hero = () => {
  return (
    <section
      id="home"
      className="relative z-10 overflow-hidden bg-[url('/images/hero/background.svg')] bg-cover bg-center pt-[70px] pb-16 md:pt-[100px] md:pb-[70px] xl:pt-[130px] xl:pb-[110px] 2xl:pt-[160px] 2xl:pb-[150px]"
    >
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex -translate-y-6 flex-col items-center space-y-6">
                {teamOne.map((member, index) => (
                  <div
                    key={index}
                    className={`transform ${index % 2 === 0 ? "translate-x-2" : "-translate-x-6"} overflow-hidden rounded-xl border border-white bg-transparent p-4`}
                  >
                    <div>
                      <img
                        src={member.image}
