...
export const NavbarButton = ({
  ...
  const baseStyles =
    "px-4 py-2 rounded-full bg-black button text-white text-sm font-semibold relative cursor-pointer hover:-translate-y-0.5 transition duration-200 inline-block text-center";
