...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    body: "Jag uppskattar särskilt att inget tappas bort och att alla delar i processerna fångas upp. Det minskar sårbarheten i organisationen och gör att vi minimerar risken att missa något. bort och att alla delar i processerna fångas upp. Det minskar sårbarheten i organisationen och gör att vi minimerar risken att missa något",
  ...
  },
  {
    ...
    description: "Ekonom - BS Verkstäder",
    body: "Evity har den bästa supporten jag någonsin varit med om. Det personliga bemötandet och den snabba återkopplingen har skapat en känsla av trygghet och tillit som är mycket värdefull. bort och att alla delar i processerna fångas upp. Det minskar sårbarheten i organisationen och gör att vi minimerar risken att missa något",
    img: "/images/testimonials/person-4.avif",
  },
  {
    name: "Nina Wiberg Karlsson",
    description: "HR-chef - Fyrklövern",
